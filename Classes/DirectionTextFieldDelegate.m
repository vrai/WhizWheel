...
@implementation DirectionTextFieldDelegate
...
{
    return [ [ TextFormatter defaultFormatter ] formatDirection: [ contents intValue ] ];
}

- ( BOOL ) validateTextFieldContents: ( NSString * ) contents
{
    return [ [ TextValidator defaultValidator ] validateStringAsDirection: contents ];
}
