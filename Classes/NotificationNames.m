...
NSString * const WindDetailsPublished          = @"WindDetailsPublished";
NSString * const WindDetailsRepublishRequest   = @"WindDetailsRepublishRequest";
NSString * const WindRoseResultsPublished      = @"WindRoseResultsPublished";